...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&logFormat, "log-format", "default", "The format for logging: 'default', 'syslog', or 'journald'")
	...
	// Explicitly set default logging format, but I'm not sure if this is redundant
	viper.SetDefault("log-format", "default")

	// Setup Logrus based on the log format setting
